...
int main() {
    ...
    Producto::cargarDesdeArchivo(listaProductos); // AÑADIDO: carga de productos
    Proveedor::cargarDesdeArchivo(listaProveedores); // AÑADIDO: carga de proveedores
    ...
    Producto::guardarEnArchivo(listaProductos); // AÑADIDO: guardado de productos
    Proveedor::guardarEnArchivo(listaProveedores); // AÑADIDO: guardado de proveedores
