...
void Reportes::informeVentas() {
    ...
    auditoria.registrar(usuarioRegistrado.getNombre(), "500", "REPVENT");
    system("pause");
}
...
void Reportes::analisisTiemposEntrega() {
    ...
    auditoria.registrar(usuarioRegistrado.getNombre(), "500", "ANALTIME");
    system("pause");
}
...
void Reportes::reporteInventarios() {
    ...
    auditoria.registrar(usuarioRegistrado.getNombre(), "500", "REPINV");
    system("pause");
}
...
void Reportes::evaluacionProveedores() {
    ...
    auditoria.registrar(usuarioRegistrado.getNombre(), "500", "EVAPROV");
    system("pause");
}
