    ...
    do {
        ...
        if (opcion == 1) {
            ...
            if (buscarUsuario(user, pass)) {
                acceso = true;
                nombre = user;
                auditoria.registrar(nombre, "000", "LOGIN");
                cout << "\n\t\tAutenticacion exitosa. Bienvenido!";
                system("pause");
                break;
            } else {
                intentos++;
                auditoria.registrar(user, "000", "LOGIN-FAIL");
...
void usuarios::registrarUsuario() {
    ...
    auditoria.registrar(nombre, "000", "REG-USER");
...
void usuarios::consultarUsuarios() {
    ...
    cout << "\t\t========================================" << endl;
    auditoria.registrar(this->nombre, "000", "CONS-USER");
    system("pause");
}
